...
{
    List<User> GenerateUserData(int numberOfUsers); // This method is to support dynamic user creation (currently not used)
    List<User> GetUserDataFromJson(string filePath);
}